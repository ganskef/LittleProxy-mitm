 ...
 * Connection failure with some HTTPS sites like https://netty.io/ or https://kitematic.com/ for example, with [Server Name Indication (SNI)](http://en.wikipedia.org/wiki/Server_Name_Indication) enabled. See the issues https://github.com/adamfisk/LittleProxy/issues/207 and https://github.com/netty/netty/issues/3801 for detailed informations.
```
