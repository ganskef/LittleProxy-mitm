...
public class BlockingNettyClientTest {
    ...
    public void testSimpleImage() throws Exception {
        ...
        File direct = //
        // new File(IMAGE_PATH);
        new NettyClient_NoHttps().get(url);

        File proxied = new NettyClient_NoHttps().get(url, proxy);
    ...
    public void testOnlineTextSecured() throws Exception {
        ...
        try {
            File direct = new NettyClient_NoHttps().get(url);
